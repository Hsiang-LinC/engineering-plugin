---
name: to-prd
description: Turn the current conversation context into a PRD and publish it through the repo harness. Use when user wants to create a PRD from the current context.
---
